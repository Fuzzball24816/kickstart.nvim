  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      require('telescope').setup {
        defaults = { path_display = { 'truncate', 'filename_first' }, file_ignore_patterns = { 'node_modules', 'package%-lock.json' } },
            ...
            plugins = {
              {
                ...
                location = require('mason-registry').get_package('angular-language-server'):get_install_path() .. '/node_modules/@angular/language-server/src',
    ...
    keys = {
      {
        ...
        desc = 'Open mini.files at current file dir',
      },
    },
  },
  {
